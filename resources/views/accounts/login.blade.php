        ...
        <div class="row d-flex">
            <div class="col-lg-6">
                <div class="card1 pb-5">
                    ...
                    <div class="row px-3 justify-content-center mt-5 order-line"> <img
                            src="https://sme.asia/en/wp-content/uploads/2020/05/20200513-SME-Singapore-New-ECommerce-Image.jpg" class="image"> </div>
                </div>
            </div>
            <div class="col-lg-6">
                    ...
                    <form action="{{ route('login.submit') }}" method="post">
                        ...
                        <div class="row px-3 mb-4">
                            <div class="custom-control custom-checkbox custom-control-inline"> <input id="chk1"
                                    ...
                                    class="custom-control-label text-sm">Remember me</label> </div> <a href="{{route('forget')}}"
                                class="ml-auto mb-0 text-sm">Forgot Password?</a>
                        </div>
                        <div>
                        <div class="row mb-3 float-left"> <button type="submit"
                                class="btn btn-blue text-center">Login</button>
                        </div>
                        <div class="row mb-3 float-right"> <button type="submit"
                                class="btn btn-danger text-center">Login with Google </button>
                        </div></div>
                    </form>
                    @if ($errors->has('succes'))
                        'Registered'
                    @endif
                    <div class="row mb-4 px-3"> <small class="font-weight-bold">Don't have an account? <a href="{{route('register')}}"
