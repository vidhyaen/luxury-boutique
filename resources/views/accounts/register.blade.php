...
<div class="row">
    <div class="col-3"></div>
       ...
       <h3 class="mb-0 mr-4  text-center text-danger">Sign Up</h3>
        
        <form action="{{ route('register.submit') }}" method="post" class="p-2 mt-2">
            @csrf
            @method('POST')
...
<div class=" px-3 text-center"> <button type="submit"
    class="btn btn-blue text-center">Register</button>
</div>
        </form>
</div>
</div>
