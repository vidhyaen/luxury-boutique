<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('Productdetail')}}">Product details</a>
                <a class="collapse-item" href="{{route('stock')}}">Stock details</a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Variant:</h6>
                <a class="collapse-item" href="{{route('color')}}">Colors</a>
                <a class="collapse-item" href="{{route('addcolor')}}">Add Colors</a>
               
                <a class="collapse-item" href="{{route('admin.sizevariant')}}">Size</a>
                <a class="collapse-item" href="{{route('addsize')}}"> Add Size</a>
    ...
    <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse show " aria-labelledby="headingPages" data-parent="#accordionSidebar" >
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('admin.customer.list')}}">Customer details</a>
                <a class="collapse-item" href="{{route('cartdetails')}}">Cart details</a>
              
                <a class="collapse-item" href="{{route('order')}}">Order details</a>
                <a class="collapse-item" href="{{route('status')}}">Order Status</a>
                <a class="collapse-item" href="{{route('addstatus')}}"> Add Status</a>
        ...
        <div id="collapsePages" class="collapse show " aria-labelledby="headingPages" data-parent="#accordionSidebar" >
            <div class="bg-white py-2 collapse-inner rounded">
                <div class="collapse-divider">
                    <h6 class="collapse-header">Customer preference:</h6>
                    <a class="collapse-item" href="{{route('frequent_click')}}" style="color: black">Frequent click </a>
                    <a class="collapse-item" href="{{route('custom_search')}}" style="color: black">Searches</a>
                    <a class="collapse-item" href="{{route('customer-form')}}" style="color: black">Add Customer level</a>
                    <a class="collapse-item" href="{{route('offers')}}" style="color: black">offer</a>
    ...
    <li class="nav-item">
        <a class="nav-link" href="#">
            ...
            <span>Notification maintance</span></a>
    </li>
    <li class="nav-item">
 ...
 */
    ...
    *::after {
    ...
    .text-dark {
        color: #5804f3 !important;
    }

    a.text-dark:hover,
    a.text-dark:focus {
        color: #4807fc !important;
    }
    ...
    .text-white-50 {
        color: rgba(40, 9, 97, 0.5) !important;
    }
    ...
    .bg-gradient-primary {
        background-color: #4e73df;
        background-image: linear-gradient(180deg, #020408 10%, #050608 100%);
    ...
    .border-left-primary {
        border-left: 0.25rem solid #000208 !important;
    }

    .border-bottom-primary {
        border-bottom: 0.25rem solid #00030a !important;
    }
    ...
    .sidebar-dark hr.sidebar-divider {
        border-top: 1px solid rgba(211, 194, 194, 0.15);
    }
    ...
    .sidebar-dark #sidebarToggle {
        background-color: rgba(192, 95, 95, 0.2);
    }
    ...
    .sidebar-dark #sidebarToggle:hover {
        background-color: rgba(214, 169, 169, 0.25);
    }
    ...
    .error:before {
        ...
        position: absolute;
        left: -2px;
        text-shadow: 1px 0 hsl(225, 94%, 25%);
        top: 0;
        color: #5a5c69;
        background: #f8f9fc;
        overflow: hidden;
